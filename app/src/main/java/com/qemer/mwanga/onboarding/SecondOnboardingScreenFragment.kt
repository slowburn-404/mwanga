 ...
 * Use the [SecondOnboardingScreenFragment.newInstance] factory method to
...
class SecondOnboardingScreenFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SecondOnboardingScreenFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SecondOnboardingScreenFragment().apply {
