 ...
 * Use the [FirstOnboardingScreenFragment.newInstance] factory method to
...
class FirstOnboardingScreenFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FirstOnboardingScreenFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FirstOnboardingScreenFragment().apply {
